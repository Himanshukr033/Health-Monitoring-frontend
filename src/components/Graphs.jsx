  ...
  useEffect(() => {
    ...
    return (
            <div style={{position: "relative",marginTop:'20px'  }}>
                <div className={`sub-header ${visible ? 'slide-in-right' : ''}`} style={{ display: "flex", width:'62vw', justifyContent: "space-between" }}>
                ...
                <div className={`${visible ? 'slide-in-right' : ''}`} style={{ alignItems: "flex-start", display: "inline-flex", flexDirection: "column", gap: "23px", left: "0px", position: "absolute", top: "40px", height:'260px', maxWidth:'62vw', overflow:"hidden" }}>
                ...
                <div className={`${visible ? 'slide-in-top' : ''}`} style={{ left: "80px", position: "absolute", top: "68px", }}>
